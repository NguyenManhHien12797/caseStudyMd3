    ...
    <div class="grid">
      <nav class="header__navbar">
        <ul class="header__navbar-list">
          ...
          <li class="header__navbar-item ">
            <a href="/admin" class="header__navbar-item-seller">Kênh Admin</a>
          </li>
        ...
        <ul class="header__navbar-list">
          ...
          <c:if test='${sessionScope["users"] != null}'>
            <li class="header__navbar-item header__navbar-user">
              <img class="header__navbar-user-img" src="${sessionScope["users"].getAvatar()}" alt="">
              <span class="header__navbar-user-name">${sessionScope["users"].getName()}</span>
