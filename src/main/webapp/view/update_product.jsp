    ...
    <div class="grid ">
        <div class="grid__row gird__row__add">
            <div class="grid__column-12">
                <span class="add__title">Sửa sản phẩm</span>
                <span class="add__dicrip">Vui lòng chọn ngành hàng phù hợp cho sản phẩm của bạn</span>

                <form action="/ShopBae?action=update" method="post" class="form__add">
                    <div class="input">
                        <span class="input__title">Tên sản phẩm</span>
                        <input type="text" name="id" value="${requestScope["shoes"].id}" hidden>
                    ...
                    <button class="btn add-product">+ Update</button>
                </form>
            </div>
        </div>
    </div>
